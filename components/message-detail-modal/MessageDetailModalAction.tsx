              ...
              <div className="flex justify-between pt-4">
                ...
                <div className="space-x-2">
                  <button
                    type="button"
                    onClick={onClose}
                    className="inline-flex items-center px-12 py-2 border border-transparent text-sm leading-4 font-medium rounded-md shadow-sm text-white border border-primary text-primary hover:bg-sky-100 focus:outline-none">
                    Close
                  </button>
